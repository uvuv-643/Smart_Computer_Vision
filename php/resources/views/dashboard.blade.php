...
{{--                        <div class="home__video__title">Онлайн-трансляция</div>--}}
                        ...
                        <div class="home__stats">
                            ...
                            @else
                                ...
                                <div class="home__stats__count">
                                    На данный момент видеокамера выключена или возникла техническая проблема.
                                    <span class="text-orange-700">Невозможно посчитать количество людей в аудитории</span>
                                </div>
